	...
	<div class="row my-5">
		...
		<div class="col">
			<div class="col-12 text-end border-bottom border-3 mb-3 pb-3">
				<input type="button" value="목록보기" class="btn btn-secondary" onclick="location.href='main'">
			</div>
			<div class="row border-bottom border-3 pb-5 mb-5">
				...
				<div class="col-6">
					...
					<c:if test="${sessionScope.loginId eq auction.id && auction.startDate > current }">
						...
						<c:if test="${sessionScope.loginId ne auction.id && auction.startDate >= current && auction.endDate <= current}">
							<div class="row">
